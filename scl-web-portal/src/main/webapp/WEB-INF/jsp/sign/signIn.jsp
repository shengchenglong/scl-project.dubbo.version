        ...
        <div class="row">
            <div class="col-md-7">
                <div class="signin-info">
                    ...
                    <div class="mb20"></div>
                    <strong>Not a member? <a href="${ctx }/manage/start/toRegist">Sign Up</a></strong>
                </div><!-- signin0-info -->
            ...
            <div class="col-md-5">
                ...
                <form id="editForm" method="post" action="${ctx }/manage/login">
                    <h4 class="nomargin">Sign In</h4>
                   	<c:choose>
                   		<c:when test="${errorCode ne null }"><p class="mt5 mb20" style="color: red">${errorCode }</p></c:when>
