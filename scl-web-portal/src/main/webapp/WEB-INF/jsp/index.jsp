          ...
          <div class="panel panel-success panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="${ctx }/static/bracket/images/is-user.png" alt="" />
                  </div>
                  <div class="col-xs-8">
          ...
          <div class="panel panel-dark panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="${ctx }/static/bracket/images/is-money.png" alt="" />
                  </div>
                  <div class="col-xs-8">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4">
          <div class="panel panel-default widget-photoday">
            <div class="panel-body">
              <a href="" class="photoday"><img src="${ctx }/static/bracket/images/photos/photo1.png" alt="" /></a>
