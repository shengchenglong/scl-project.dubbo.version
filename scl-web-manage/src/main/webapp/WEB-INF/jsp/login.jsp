...
<head>
    ...
    <!-- ace styles -->
    <link rel="stylesheet" href="${ctx}/static/manage/ace-master/assets/css/ace.min.css" />

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="${ctx}/static/user/ace-master/assets/css/ace-part2.min.css" />
    <![endif]-->
                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <form id="loginForm" action="${ctx}/manage/login" method="post">
                                        <fieldset>
...
<script type="text/javascript">
    if('ontouchstart' in document.documentElement) document.write("<script src='${ctx}/static/user/ace-master/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
</script>
